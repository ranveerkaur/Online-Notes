      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="navbarCollapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#" >Logged in as <b> <?php echo $_SESSION['username'] ?></b></a>
            </li>
...
<p id="alertContent"></p>
          ...
          <button id="addnote" type="button" class="btn green btn-lg">Add Note</button>
            <button id="edit" type="button" class="btn green btn-lg pull-right">Edit</button>
              <button id="done" type="button" class="btn btn-info btn-lg pull-right">Done</button>
                <button id="allnotes" type="button" class="btn green btn-lg">All Notes</button>
    ...
    <div class="footer">
      <div class="container">
        <p>  2020-<?php $today=date("Y"); echo $today?></p>
      </div>
    </div>
