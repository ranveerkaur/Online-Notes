...
if(!$result){
  ...
  echo "<div class='alert alert-success'>Thank for your registering!</div>";



//Send the user an email with a link to activate.php with their email and activation code
//$message = "Please click on this link to activate your account:\n\n";
//$message .= "http://localhost/mynotes/activate.php?email=" . urlencode($email) . "&key=$activationKey";
//if(mail($email, 'Confirm your Registration', $message, 'From:'.'ranveerkaur1316@gmail.com')){
