...
<link href="https://fonts.googleapis.com/css?family=Work+Sans&display=swap" rel="stylesheet">
  ...
  <body>
    ...
    <div class="jumbotron" id="myContainer">
      ...
      <p>Its safe, secure and free of cost!</p>
       ...
       <div class="modal-dialog">
         <div class="modal-content">
           <div class="modal-header">
             ...
             <h4 id="myModalLabel">
               Hurry up! and start using online notes app!
             </h4>
         </div>
         <div class="modal-body">
           <!--signup message-->
           ...
           <div class="form-group">
             ...
             <input class="form-control" type="password" id="password2" name="password2" placeholder="Confirm a password" maxlength="30">
           </div>
         </div>
         <div class="modal-footer">
           <input class="btn green" name="signup" type="submit" value="signup">
           <button type="button" class="btn btn-default" data-dismiss="modal">
             Cancel
           </button>
    ...
    <div class="footer">
      <div class="container">
        <p>  2018-<?php $today=date("Y"); echo $today?></p>
      </div>
    </div>
